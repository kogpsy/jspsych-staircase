...
| ----------------------------------- | -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| jsPsychInstance                     | object   | The jsPsych instance of your experiment.                                                                                                                                                                                                                                                                                                                    |
...
| difficulty                          | object   | The difficulty object, with a `max` and a `min` field, as well as a `set()` and a `get()` function. See the example above to learn what this is exaclty.                                                                                                                                                                                                    |
| cycle                               | object   | A jsPsych node that describes one cycle. Again, see the example above for a more information.                                                                                                                                                                                                                                                               |
...
| customDifficultyAdjuster (Optional) | function | By default, if the accuracy is e.g. 20% higher than the target accuracy, the difficulty will be increased by half of that value (i.e. 10%). To change this behavior, you can supply a custom adjuster function. It should take a difficulty object (see above), the accuracy of the past cycle and the target accuracy, and return the adjusted difficulty. |
